...
CORS_ORIGINS = os.environ.get("CORS_ORIGINS", "http://localhost,https://localhost,http://localhost:5173,http://localhost:5174,http://localhost:8000,https://tauri.localhost,tauri://localhost,https://culrecords.duckdns.org,http://141.147.48.186,https://141.147.48.186").split(",")
